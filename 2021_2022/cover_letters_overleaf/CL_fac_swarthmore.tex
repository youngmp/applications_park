...
%\School~features top researchers in mathematical neuroscience, including \textbf{Victor Barranca} and \textbf{Joshua Goldwyn}. My computational and mathematical neuroscience experience will augment their work through collaborations, and I will complement their work through my independent research program. In addition to neuroscience, I research questions in cell physiology using methods from fluid dynamics. In addition, I use machine learning and subspace identification methods to analyze biological networks.
