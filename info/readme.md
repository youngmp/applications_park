...
* You eventually want an academic faculty position in a math or applied math department (as opposed to an industry or national lab position).
...
* My applications and CV are primarily tailored for R1 (Doctoral Universities – Very high research activity) positions, although there are plenty of applications for liberal arts colleges (LACs).

# Ideal conditions before applying

Note that these are only **ideal** conditions. They are neither necessary nor sufficient to obtain a postdoc or faculty position due to significant stochasticity in the hiring process. If you are less strong in one or more of these categories, do your best to improve them as you can, but do not despair.
* **Networking**: Make friends. Chat with people. In your department. Outside your department. Show interest in them and what they do. Ask about what they are working on. Ask about their hobbies.
  * Conferences are a natural place to network. In the next conference, make new friends, reach out to professors in your field, reach out to old colleagues/friends, and show genuine interest. Talk to junior and senior grad students. Introduce yourself to various people at every level. Yes it is difficult and exhausting, but it is important.
  * If you have trouble talking to people, find ways to learn how. Learning how to socialize is a tractable problem.
  * If you feel discouraged by several interactions, just remember that academics, just like any other group of people, are linear combinations of good and bad personality traits.
* Publishing: It goes without saying that published papers should be in reputable journals.
...
* Teaching: You should have plenty of teaching experience leading recitaitons or lectures for undergraduate classes. Save evaluations from each course (evaluations should be administered by the university and **not** by a third party, e.g., RateMyProfessors). "Plenty" is also field-dependent, so ask around.
  * I taught the equivalent of 3 recitations per semester (where 2 recitations were viewed as equal to 1 lecture) and one lecture every Summer.   * I happened to teach less as a postdoc, on the order of at most 1 lecture per semester, and was told by a pure mathematician that this is generally not enough teaching if I am competing for TT positions in math departments. So I sought more teaching assignments.
...
* **Math and science are very different in practice**
  * The sciences, engineering, and medicine generally require far more grants, and obtaining a big grant is usually an expectation for tenure.
    * Undergrads, and especially graduate students, postdocs, and faculty live and die by grants.
    * Positions in scientific disciplines are largely funded by grants (in contrast to math, which traditionally funds PhD, postdoc, and faculty positions through teaching).
...
* Ask people in the field you want to work in what their day-to-day life is like. Doing this is important to help manage expectations.
  * I know of cases where even those who *wanted* to switch fields from math to science took 5+ years to reach a point where they felt comfortable.
* More to come...
